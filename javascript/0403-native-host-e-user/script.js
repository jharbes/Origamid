...
Ou seja, eles existem no node por exemplo mas alguns nao existem sem a intervencao do browser como pro exemplo NodeList, nesse caso esse seria um objeto Host
...
if (typeof Array.from !== "undefined")
    console.log('existe') //resṕosta
else
    console.log('nao existe') 


if (typeof NodeList !== "undefined")
    console.log('existe') //resposta
else
    console.log('nao existe') 


if (typeof carSystem !== "undefined")
    console.log('existe')
else
    console.log('nao existe') //resposta
